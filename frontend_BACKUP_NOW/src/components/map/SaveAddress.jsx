...
import { createAddress, setDefaultAddress } from "../../api/addressApi";
...
// Jo address abhi create hua hai usko default bana do
await setDefaultAddress(response.data.id);

alert("Address Saved Successfully");

// Home page par wapas bhej do
navigate("/");
