...
const Navbar = () => {
  ...
  const handleLogout = () => {
    ...
    // Keep the existing deployed auth behavior intact.
          ...
          {!isAuthenticated ? (
            <div className="flex items-center gap-2">
              <Link
                ...
                className="
                  ...
                  hover:bg-white/10 hover:border-blue-400/60
            ...
            <div className="relative">
              ...
              >
                ...
                <span className="hidden 2xl:block max-w-[110px] truncate text-sm font-semibold">
                  {displayName}
                </span>

                <span
                  className={`
                    hidden 2xl:block text-gray-400 text-[10px]
              ...
              {profileMenu && (
                <div
                  className="
                    ...
                    rounded-2xl shadow-2xl overflow-hidden z-[1000]
                  "
                >
